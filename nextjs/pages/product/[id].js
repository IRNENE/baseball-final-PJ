...
export default function ProductDetail() {
  ...
  if (productDetail) {
    ...
    const images = [
      `/images/product/${productData.image_url}`,
      `/images/product/${productData.red}`,
      `/images/product/${productData.green}`,
      `/images/product/${productData.blue}`,
      `/images/product/${productData.yellow}`,
    ]
      ...
      <>
        <div className="container ">
          <div className={`breadcrumb  ${styles.breadcrumb}`}>
            <a href="/product" className={`tete ${styles.tete}`}>
              所有商品
            </a>{' '}
            /
          ...
          <div className="row">
            <div className={`col-12 col-sm-6 left1  ${styles.left1}`}>
              <div
                className={`zoom-container bigpic ${styles.bigpic}`}
                ...
                <div className=" mt-3">
                  <div className={`pric1 me-2  ${styles.pric1}`}>
                    <h3 className=" text-danger">
                      ${Math.round(productData.price * 0.8)}
                    </h3>
                  </div>
            ...
            <option key={index} value={size}>{size}</option>
                ...
                <div className={`divv row  mt-3   ${styles.divv}`}>
                  ...
                  <div className={`div3333 ${styles.div3333}`}>
                    <button
                      className={`div4 ${styles.div4}`}
                      type="button"
                      onClick={handleDecrement}
                    >
                      -
                    </button>
                    <div className={`div5 text-danger ${styles.div5}`}>
                      {quantity}
                    </div>
                    <button
                      className={`div6 ${styles.div6}`}
                      type="button"
                ...
                <div className="d-grid gap-2    mt-3 ">
                  <button
                    className="btn btn-danger rounded-0 d-flex justify-content-center align-items-center"
                    type="button"
                  ...
                  <button
                    ...
                    className="btn btn-dark rounded-0 mt-2 d-flex justify-content-center align-items-center"
                    type="button"
                  >
                    <div className="d-flex align-items-center">
                      <Image
                ...
                <div className="mt-3">
                  <div className="d-flex  ">
                    ...
                    <p className="pt-1">
                      滿 <span className={`qq1 ${styles.qq1}`}>5000</span>{' '}
                      元即享免運
                    </p>
                  </div>
                  <div className="d-flex  ">
          ...
          <div className="row">
            <div className={`col-12 col-sm-6  left1  ${styles.left1}`}>
              <div
                className={`ppp d-flex  align-items-center mb-4  ${styles.ppp} ${styles.qqq2}`}
              >
                <div
                  className=""
                  style={{
              ...
              {comment.length === 0 ? (
                ...
                comment.slice(0, 2).map((comment) => (
                  <div
                    key={comment.id}
                    className={`card rounded-0 shadow  ${styles.card}`}
                  >
            ...
            <div className={`col-12 col-sm-6  right1 sss  ${styles.right1} `}>
              ...
              <div
                className={`allp mt-2  ${styles.allp} ${styles.recommendedContainer}`}
              >
                  ...
                  return (
                    <Link key={product.id} href={`/product/${product.id}`}>
                      <div className={`box7  ${styles.box7}`}>
                        ...
                        <div
                          className={`single-ellipsis name1 ${styles.singleEllipsis}`}
                        >
                          {product.name}
                        </div>

                        <h6 className={`box8 me-2 ${styles.box8}`}>
                          ${Math.round(product.price * 0.8)}
                        </h6>
                        <p className={`box9 ${styles.box9}`}>
                          ${product.price}
                        </p>
                      </div>
                    </Link>
